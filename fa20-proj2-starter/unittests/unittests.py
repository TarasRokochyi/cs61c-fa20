...
class TestWriteMatrix(TestCase):
    ...
    def do_fail_write_matrix(self, fail, code):
        t = AssemblyTest(self, "write_matrix.s")
        outfile = "outputs/test_write_matrix/student.bin"
        # load output file name into a0 register
        t.input_write_filename("a0", outfile)
    ...
    def test_malloc(self):
        self.do_fail_write_matrix(fail="malloc", code=88)

    def test_fopen(self):
        self.do_fail_write_matrix(fail="fopen", code=93)

    def test_fwrite(self):
        self.do_fail_write_matrix(fail="fwrite", code=94)

    def test_fclose(self):
        self.do_fail_write_matrix(fail="fclose", code=95)
...
class TestMain(TestCase):
    ...
    def run_main(self, inputs, output_id, label):
        ...
        t.call("main")
        t.execute(args=args, verbose=True)
